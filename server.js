...
// Utilisation de process.env.PORT pour que Render définisse le port automatiquement
const PORT = process.env.PORT || 5000;

// Dossier public pour les fichiers statiques (serveur de page web)
...
// Liste des IPs publiques à surveiller (exemple d'IP)
...
const ipToCityMap = {
  "80.14.43.74": "Angers", "217.128.247.87": "Nancy", '86.214.116.135': "Montpellier", "92.173.237.27": "Caen", "72.14.201.119": "Lyon", "37.58.153.5": "Paris", "37.58.130.51": "Anzin", "185.149.218.234": "Saint-Jeoire Koe", "212.84.57.223": "Saint-Jeoire Rez", "193.252.196.19": "Bruz"
};
...
// Lancer immédiatement et toutes les 10 secondes
updateSlackStatus();
...
testPing();
setInterval(testPing, 60000); // Test ping toutes les 60 secondes

// Récupérer les données des services via API
...
// Lors d'une mise à niveau de connexion WebSocket
